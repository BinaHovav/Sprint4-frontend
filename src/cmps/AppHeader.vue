<template>
  <header ref="header" class="header-container">
    <nav>
      <RouterLink to="/board">
        <img
          src="https://res.cloudinary.com/dyu8jwe4o/image/upload/v1690982880/Screenshot_2023-08-02_at_16.27.27_t0v0qv.png"
          alt="logo" />
      </RouterLink>
      <div class="nav-left-content">
        ...
        <div class="create-menu">
          <button class="create-menu-button" ref="createBoardAppHeader"
            @click="openModal('CreateBoardModal', 'createBoardAppHeader')">
            <p>Create</p>
          </button>
        </div>
      </div>
